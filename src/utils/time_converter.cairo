...
func epoch_to_timestamp{range_check_ptr}(epoch: felt) -> (year: felt, month: felt, day: felt, hour: felt, minutes: felt, seconds: felt) {
...
func epoch_to_date{range_check_ptr}(epoch: felt) -> (year: felt, month: felt, day: felt) {
